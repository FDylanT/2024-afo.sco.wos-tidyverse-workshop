...
pufflings <- read_csv("puffling_weights.csv")
puffins <- read_csv("Fratercula_foraging.csv")
dates <- read_csv("Fratercula_sampling_dates.csv")
```
...
ggsave("puffling_growth.png", width = 6, height = 8, units = "in", dpi = 600)
```
...
write_csv(puffins_combined, "allData.csv")
write.csv(puffins_combined, "allData2.csv")
